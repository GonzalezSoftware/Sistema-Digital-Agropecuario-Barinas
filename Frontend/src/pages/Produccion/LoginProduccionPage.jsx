        ...
        <div style={{
          ...
          <div style={{ position: "relative", zIndex: 2 }}>
            <h1 style={{
              ...
              <span style={{ color: "#86efac" }}>Agropecuaria</span>
            </h1>
            ...
            <p style={{
              ...
              Área exclusiva para personal autorizado del MPPAT.
              Ingresa tus credenciales para acceder al sistema de gestión productiva.
            </p>
          </div>

          <div style={{ position: "relative", zIndex: 2, display: "flex", gap: "14px" }}>
            {[
              { num: "Producción", label: "Vegetal" },
              { num: "Producción", label: "Animal" },
              { num: "Control", label: "Total" },
            ].map(item => (
              <div key={item.label} style={{
                ...
                <div style={{ fontSize: "14px", fontWeight: 700, color: "#fff" }}>{item.num}</div>
                <div style={{ fontSize: "11px", color: "rgba(255,255,255,0.55)" }}>{item.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{
          ...
          <div style={{ width: "100%", maxWidth: "400px", animation: "fadeInUp 0.5s ease" }}>
            ...
            <div style={{ marginTop: "20px", textAlign: "center" }}>
              <button onClick={() => navigate("/produccion")} className="link-volver"
                style={{
